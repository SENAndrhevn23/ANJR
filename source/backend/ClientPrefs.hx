...
class SaveVariables
{
	...
	public var skipNoteEvent:Bool = false;
	public var spawnNoteEvent:Bool = true;

	// Renderer / video settings
	public var gameRenderer:Bool = false; // Requires FFmpeg
	public var previewRender:Bool = false;
	public var targetFPS:Int = 60;
	public var encodeMode:String = 'CRF/CQP';
	public var constantQuality:Int = 18;
	public var bitrate:Int = 8;
